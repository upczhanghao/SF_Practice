          ...
          <div class="addr-right fr">
            ...
            <div class="list3">
              <ul>
                ...
                <li>
                  <p>
                    <input type="checkbox" v-model="defa"> 设置为默认地址
                  </p>
                </li>
              </ul>
              <input type="button"  value="确认添加" class="submit1" @click="submit">
            </div>
          </div>
        </div>
      </div>
    ...
    export default {
      ...
      methods:{
          submit(){
            ...
            formdata.append('defa',this.defa);
            //省略数据校验
            axios({
              url:'http://49.233.165.235:8080/v1/addaddr',
              method:'post',
